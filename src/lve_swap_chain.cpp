...
LveSwapChain::LveSwapChain(
    ...
    : device{deviceRef}, windowExtent{extent}, renderPass{renderPass} {
    init();
}
...
LveSwapChain::LveSwapChain(
    ...
    : device{deviceRef}, windowExtent{extent}, oldSwapChain{previous}, renderPass{renderPass} {
    init();
...
LveSwapChain::~LveSwapChain() {
    ...
    vkDestroyRenderPass(device.device(), oldRenderPass, nullptr);
